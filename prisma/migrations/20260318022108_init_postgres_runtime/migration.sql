-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CUSTOMER', 'OPERATIONS', 'ADMIN');
...
-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('UNPAID', 'REQUIRES_ACTION', 'PAID', 'FAILED');
...
-- CreateIndex
CREATE INDEX "OperationalLog_scope_idx" ON "OperationalLog"("scope");

-- CreateIndex
CREATE INDEX "OperationalLog_requestId_idx" ON "OperationalLog"("requestId");

-- CreateIndex
CREATE INDEX "OperationalLog_userId_idx" ON "OperationalLog"("userId");

-- CreateIndex
CREATE INDEX "OperationalLog_orderId_idx" ON "OperationalLog"("orderId");
